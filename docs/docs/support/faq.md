...
As the presenter, if you want to share a YouTube, Vimeo, Dailymotion or Panopto video, use the built-in `Share an external video` feature (Select the '+' button to see this option).
