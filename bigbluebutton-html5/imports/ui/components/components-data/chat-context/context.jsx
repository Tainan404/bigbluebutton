  ...
  const msgBuilder = (msg, chat) => {
    ...
    const tempGroupMessage = {
      [messageKey]: {
        ...
        content: [
          { id: msg.id, textHtmlSafe: msg.messageHtmlSafe, text: msg.message, time: msg.timestamp },
        ],
      }
    };
      ...
      if (groupMessage.sender === stateMessages.lastSender) {
        ...
        messageGroups[timeWindowKey] = {
          ...
          content: [
            ...
            { id: msg.id, textHtmlSafe: msg.messageHtmlSafe, text: msg.messsge, time: msg.timestamp }
          ],
        };
