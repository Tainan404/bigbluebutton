...
trait FakeTestData {
  ...
  def createFakeUsers(liveMeeting: LiveMeeting): Unit = {
    ...
    val guestWait1 = GuestWaiting(guest1.intId, guest1.name, guest1.role, guest1.guest, "", "", "#ff6242", System.currentTimeMillis())
    ...
    val guestWait2 = GuestWaiting(guest2.intId, guest2.name, guest2.role, guest2.guest, "", "", "#ff6242", System.currentTimeMillis())
