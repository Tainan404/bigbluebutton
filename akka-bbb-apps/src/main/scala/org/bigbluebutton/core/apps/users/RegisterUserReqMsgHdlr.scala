...
trait RegisterUserReqMsgHdlr {
  ...
  def handleRegisterUserReqMsg(msg: RegisterUserReqMsg): Unit = {
    ...
    def buildUserRegisteredRespMsg(meetingId: String, userId: String, plainFullname: String, htmlFullname: String,
      ...
      val body = UserRegisteredRespMsgBody(meetingId, userId, plainFullname, htmlFullname, role, excludeFromDashboard, registeredOn)
    ...
    val regUser = RegisteredUsers.create(msg.body.intUserId, msg.body.extUserId,
      msg.body.plainFullname, msg.body.htmlFullname, msg.body.role, msg.body.authToken,
    ...
    val event = buildUserRegisteredRespMsg(liveMeeting.props.meetingProp.intId, regUser.id, regUser.plainFullname, regUser.htmlFullname,
    ...
    guestStatus match {
      ...
      case GuestStatus.WAIT =>
        val guest = GuestWaiting(regUser.id, regUser.htmlFullname, regUser.role, regUser.guest, regUser.avatarURL, regUser.authed, regUser.registeredOn)
